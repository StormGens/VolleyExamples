...
import com.stormgens.volleyexamples.misc.PicasaArrayAdapter;
import com.stormgens.volleyexamples.misc.PicasaEntry;
...
public class ListRequestActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.list_request, menu);
		return true;
	}
